        ...
        <Container>
            ...
            <Form className="w-50 mx-auto">
                <Form.Group>
                    ...
                    <Form.Control type="number" placeholder='Masukkan nomor NIP anda' required onChange={(event) => handleNIP(event.target.value)} />
                </Form.Group>
                <Form.Group>
                ...
                <Button className="mt-4 w-100" onClick={() => userRegister()} Primary >Register</Button>
            </Form>
        </Container>
    )
}
